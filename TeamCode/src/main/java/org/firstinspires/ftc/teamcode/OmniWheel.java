...
public class OmniWheel
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        F_leftMotor.setDirection(DcMotor.Direction.REVERSE); // Set to REVERSE if using AndyMark motors
        F_rightMotor.setDirection(DcMotor.Direction.FORWARD);
        B_leftMotor.setDirection(DcMotor.Direction.REVERSE); // Set to REVERSE if using AndyMark motors
        B_rightMotor.setDirection(DcMotor.Direction.FORWARD);// Set to FORWARD if using AndyMark motors
//
